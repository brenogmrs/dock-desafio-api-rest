...
export class Account1649625206372 implements MigrationInterface {
    name = 'Account1649625206372'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "account_holder_id" uuid NOT NULL, "number" integer NOT NULL, "agency" character varying NOT NULL, "balance" numeric(10,2) NOT NULL DEFAULT '0', "status" character varying NOT NULL DEFAULT 'AVAILABLE', CONSTRAINT "REL_4ad01f8177844b73cca3dd0973" UNIQUE ("account_holder_id"), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`);
